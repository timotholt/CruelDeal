...
// Changed from const enum to regular enum for Vite/ESM compat
...
export abstract class BasisField {
    ...
    setGui(parent: dat.GUI, folder: dat.GUI): void {
        ...
        folder.add(this as any, '_size');
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        folder.add(this as any, '_decay', -50, 50);
    }
...
export class Grid extends BasisField {
    ...
    setGui(parent: dat.GUI, folder: dat.GUI): void {
        ...
        thetaController.onChange((theta: number) => this._theta = theta * (Math.PI / 180));
    }
