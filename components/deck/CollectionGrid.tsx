...
export const CollectionGrid = (props: CollectionGridProps) => {
    ...
    return (
        <div class="w-full h-full flex flex-col">
            <div 
                ref={props.scrollRef} 
                class="flex-1 overflow-hidden px-2.5 pt-2 pb-52 touch-none select-none"
                onPointerDown={(e) => props.onPointerDown(e, null)} 
            >
                 <Show when={filteredAndSortedCards().length > 0} fallback={
                     ...
                     <div class="grid grid-cols-5 gap-x-1.5 gap-y-2.5 justify-items-center">
