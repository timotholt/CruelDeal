...
const stateDescription = (plan: FingerprintHoldActionRuntimePlanV1, state: FingerprintHoldState) => {
...
/** Native compiled action host. It intentionally has no Material Lab import. */
export const CompiledFingerprintHoldAction = (props: {
  ...
  return (
    <button
      ...
      style={{ '--ui-hold-duration': `${props.plan.holdDurationMs}ms` }}
