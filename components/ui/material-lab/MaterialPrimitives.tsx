...
// The SurfaceOptions props shared by every surface host. MaterialPanel and
// MaterialButton both split these out before delegating to MaterialSurface, so
// there is one canonical list instead of two hand-maintained copies.
