...
export const surfaceFieldDefinitions = [
  ...
  field({ key: 'corners', group: 'lighting', label: 'Corners', control: 'multi-toggle', editMode: 'rest-and-state', options: materialRecipeCorners, optionLabels: bevelCornerLabels }),
  field({ key: 'edgeHighlight', group: 'lighting', label: 'Edges', control: 'multi-toggle', editMode: 'rest-and-state', options: materialRecipeEdges }),
  field({ key: 'border', group: 'border', label: 'Sides', control: 'multi-toggle', editMode: 'rest', options: materialRecipeEdges }),
  field({ key: 'glow', group: 'lighting', label: 'Glow', control: 'select', editMode: 'rest-and-state', options: materialRecipeGlows }),
  ...
  field({ key: 'edgeWearScale', group: 'edgeWear', label: 'Edge Wear Scale', control: 'slider', editMode: 'rest', min: 64, max: 4096, step: 1, valueStops: [64, 128, 256, 512, 1024, 2048, 4096] }),
  ...
  field({ key: 'emission', group: 'emission', label: 'Type', control: 'select', editMode: 'rest-and-state', options: materialRecipeEmissionKinds, optionLabels: emissionKindLabels }),
  field({ key: 'emissionEdge', group: 'emission', label: 'Edge', control: 'select', editMode: 'rest-and-state', options: materialRecipeEmissionEdges }),
  field({ key: 'emissionTone', group: 'emission', label: 'Tone', control: 'select', editMode: 'rest-and-state', options: materialRecipeTints }),
  field({ key: 'emissionStrength', group: 'emission', label: 'Power', control: 'slider', editMode: 'rest-and-state', min: 0, max: 100, step: 1 }),
  field({ key: 'emissionLength', group: 'emission', label: 'Length', control: 'slider', editMode: 'rest-and-state', min: 10, max: 100, step: 1 }),
  field({ key: 'emissionThickness', group: 'emission', label: 'Thick', control: 'slider', editMode: 'rest-and-state', min: 1, max: 8, step: 1 }),
  field({ key: 'emissionBlipSize', group: 'emission', label: 'Blip', control: 'slider', editMode: 'rest-and-state', min: 8, max: 44, step: 1 }),
