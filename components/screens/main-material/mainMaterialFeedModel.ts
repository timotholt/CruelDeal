...
import missionBriefingV1Default from './defaults/missionBriefingV1.json';
import patchNotesDefault from './defaults/patchNotes.json';
import communityDefault from './defaults/community.json';
...
export const createDefaultMissionBriefingV1CardType = (): FeedCardTypeRecipe => cloneFeedCardType(missionBriefingV1Default as unknown as FeedCardTypeRecipe);

export const createDefaultPatchNotesCardType = (): FeedCardTypeRecipe => cloneFeedCardType(patchNotesDefault as unknown as FeedCardTypeRecipe);

export const createDefaultCommunityCardType = (): FeedCardTypeRecipe => cloneFeedCardType(communityDefault as unknown as FeedCardTypeRecipe);
...
export const mockFeedStories: FeedStory[] = [
  {
    ...
    image: "/art/login/editor-temp-bg.png",
