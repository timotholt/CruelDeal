...
export function createCityMaterials() {
  return {
    ...
    roadLocal: new THREE.MeshBasicMaterial({ color: 0x35a5ff, depthTest: false, depthWrite: false, side: THREE.DoubleSide }),
    roadStreet: new THREE.MeshBasicMaterial({ color: 0x55bdff, depthTest: false, depthWrite: false, side: THREE.DoubleSide }),
    roadAvenue: new THREE.MeshBasicMaterial({ color: 0x7ad8ff, depthTest: false, depthWrite: false, side: THREE.DoubleSide }),
    roadHighway: new THREE.MeshBasicMaterial({ color: 0xb8f1ff, depthTest: false, depthWrite: false, side: THREE.DoubleSide }),
    bridge: new THREE.MeshBasicMaterial({ color: 0xd8fbff, depthTest: false, depthWrite: false, side: THREE.DoubleSide }),
