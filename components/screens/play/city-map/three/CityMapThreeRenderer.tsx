...
export const CityMapThreeRenderer = (props: CityMapThreeRendererProps) => {
  ...
  onMount(() => {
    ...
    sceneKey = `${props.model.city.seed}:${props.model.roads.length}:${props.model.blocks.length}:${props.debugState.showRoads}:${props.debugState.showBuildings}:${props.debugState.showTerrainDebug}:${props.debugState.showRoadCorridors}:${props.debugState.showTensorField}:${props.debugState.showTensorSeeds}:${props.debugState.showRejectedTensorRoads}`;
  ...
  createEffect(() => {
    ...
    const nextSceneKey = `${model.city.seed}:${model.roads.length}:${model.blocks.length}:${debugState.showRoads}:${debugState.showBuildings}:${debugState.showTerrainDebug}:${debugState.showRoadCorridors}:${debugState.showTensorField}:${debugState.showTensorSeeds}:${debugState.showRejectedTensorRoads}`;
